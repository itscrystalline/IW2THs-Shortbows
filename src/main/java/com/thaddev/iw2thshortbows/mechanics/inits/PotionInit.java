...
public class PotionInit {
    ...
    public static void registerPotions() {
        IWant2TryHardsShortbows.LOGGER.debug("Registering Potions for " + IWant2TryHardsShortbows.MODID + " (10/11)");
    ...
    private static void registerPotionRecipes() {
        IWant2TryHardsShortbows.LOGGER.debug("Registering Potion Recipes for " + IWant2TryHardsShortbows.MODID + " (10/11)");
