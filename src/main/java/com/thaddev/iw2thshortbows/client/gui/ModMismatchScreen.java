...
public class ModMismatchScreen extends Screen {
    ...
    public ModMismatchScreen(String clientModVersion, String serverModVersion, String clientModLoader, String serverModLoader) {
        super(Text.translatable(IWant2TryHardsShortbows.SCREEN_VERSION_MISMATCH));
    ...
    protected void init() {
        ...
        this.addDrawableChild(drawCenteredButtonWidget((this.width / 2) - 160, pos + 25, 150, 20, true, Text.translatable(OPEN_CURSEFORGE),
                ...
                (pButtonWidget, pPoseStack, pMouseX, pMouseY) ->
                    renderTooltip(pPoseStack, Text.translatable(OPEN_CURSEFORGE), pMouseX, pMouseY)
            )
        );
        this.addDrawableChild(drawCenteredButtonWidget((this.width / 2), pos + 25, 150, 20, true, Text.translatable(OPEN_MODRINTH),
                ...
                (pButtonWidget, pPoseStack, pMouseX, pMouseY) ->
                    renderTooltip(pPoseStack, Text.translatable(OPEN_MODRINTH), pMouseX, pMouseY)
            )
        );
