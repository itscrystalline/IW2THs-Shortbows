...
public class ClientForgeEvents {
    ...
    public static void onRenderHud(final RenderGameOverlayEvent.Post event) {
        if (IWant2TryHardsShortbows.instance.isMismatching){
            Minecraft.getInstance().font.drawShadow(event.getMatrixStack(), Utils.fromNoTag("(%$white)(%$bold)(%$underline)Version Mismatch! (from IWant2TryHardsShortbows"), 10, 10, 100);
